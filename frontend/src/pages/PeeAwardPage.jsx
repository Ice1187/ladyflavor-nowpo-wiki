...
const PeeAwardPage = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 h-full overflow-y-auto">
      <div className="mb-8">
        <h2 className="text-xl font-bold mb-4 text-secondary-dark">2022 第一屆小解獎 (EP142)</h2>
        ...
        {/* Description */}
        <div className="bg-secondary-light/20 p-4 rounded-lg mb-6 text-gray-700">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {awards.map(award => (
                <tr key={award.id} className="hover:bg-gray-50">
                  <td className={`px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900 ${award.isHighlighted ? 'font-bold' : ''}`}>
                    {award.award}
                  </td>
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 h-full overflow-y-auto">
      <div className="mb-8">
        ...
        <div className="bg-secondary-light/20 p-4 rounded-lg mb-6 text-gray-700">
          <p className="mb-2">「小」是好味小姐的小，「解」是解開束縛的解。小小解放自己心情的小天地，完全沒有也不可能有其他意思。</p>
          <p>評選原則：緣分</p>
        </div>
        ...
        <div className="overflow-hidden rounded-lg shadow">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              <tr className="hover:bg-gray-50">
                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900 font-bold">
                  年度笑話獎
                </td>
                <td className="px-4 py-4 text-sm text-gray-500">
                  Huang Yi-Pin、家有四貓很幸福、Omgoddddddd、Curtis4X、Bubu
                </td>
                <td className="px-4 py-4 text-sm text-gray-500">
                  Huang Yi-Pin
                </td>
